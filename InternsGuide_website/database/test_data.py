...
def insert_test_data():
    ...
    # Добавление тестов
    tests = [
        ('Введение в страхование', 2, 'Основные понятия и принципы страхования', 20),
        ('Продукты Ингосстрах', 3, 'Основные страховые продукты компании', 15),
        ('Корпоративные стандарты', 2, 'Проверка знаний корпоративной культуры', 10)
    ]
    cursor.executemany(
        "INSERT INTO tests (title, creator_id, description, max_score) VALUES (?, ?, ?, ?)",
        tests
    )
